...
%Halevi called finding the reductions the creative part of a proof and proving that they succeed the mundane part, and writes: ``It often happens that the mundane parts are much harder to write and verify, and it is with these parts that we can hope to have automated help.''
