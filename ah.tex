...
Both Rashid and Warinschi regularly disseminate their research at the top international venues. As part of this studentship, 
the candidate will publish his/her work in security, software engineering and human-computer interaction conferences and 
journals. We envision the milestones listed above leading to research papers at venues such as International
Symposium on Usable Privacy and Security (SOUPS), ACM SIGHI Conference on Human Factors in Computing Systems (CHI), IEEE/ACM International Conference on Software Engineering, ACM Conference on Computers and Communications Security (CCS) and IEEE Symposium on Security and Privacy. Top-tier journals such as IEEE Transactions on Software Engineering, ACM Transactions on Privacy and Security and IEEE Security \& Privacy Magazine are also suitable venues for dissemination and will be targeted. Where appropriate, poster presentations of the work will also be given at the aforementioned prestigious conference venues (especially early on in the PhD). This will increase the impact and diversity of audience who will see and engage with the research conducted in the project. 
The student will also aim to present the work to relevant practitioner and policy audiences, e.g., through posters and presentations at the annual ACE-CSR conference and the Annual Conference of Research Institutes in Cyber Security.
