...
A central part of the project is running user studies.  We envision that for the initial design and fine-tuning of developer mental models we will run two such studies in the first year.  In the subsequent two years we will run three-four more studies as part of the iterative evaluation/refinement of the mental models and novel APIs which we will produce.

We estimate transcription costs at about 1500 GPB/study and participant expenses at about 1000 GBP/study.
